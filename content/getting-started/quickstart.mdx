...
Check your agent's status and lineage proof:
...
Verify a lineage proof offline using the authority public key:
...
const valid = Provenonce.verifyProofLocally(proof, public_key_hex);
```
